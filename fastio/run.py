...
tcs = [
    ...
    (int(1e8), -int(1e9), int(1e9)),
    (int(1e5), -int(1e18), int(1e18)),
    (int(1e6), -int(1e18), int(1e18)),
    (int(1e7), -int(1e18), int(1e18)),
    (int(1e8), -int(1e18), int(1e18)),
]

md = "| 数量 | 输入量 | FastIO | cin/cout | 提速 |\n| :- | :- | :- | :- | :- |\n"
...
for tc in tcs:
    ...
    if os.system("diff 1.out 2.out -w -q"):
        print("Wrong Answer")
        break
    md += f"| ${tr(n)}$ | {tr_mem(os.stat('1.in').st_size)} | {int(x*1000)}ms | {int(y*1000)}ms | ${(y-x)/y*100:.2f}\\%$ |\n"
